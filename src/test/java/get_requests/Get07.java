...
public class Get07 extends JsonPlaceHolderBaseUrl {
    ...
    public void get01(){
        ...
        List<Integer> ids = json.getList("findAll{it.id>190}.id"); //Groovy Language = Java temelli bir programlama dili
                    // id'si 190'dan buyuk olan datalarin id'sini getir
        System.out.println(ids);
        //Assert that there are 10 ids greater than 190
        assertEquals(10,ids.size());
        //ids listinin 10 tane elemani oldugunu dogruladik

        // 3)Print all userIds whose ids are less than 5 on the console
        List<Integer> ids2 = json.getList("findAll{it.id<5}.userId");
                                        // id'si 5 ten kucuk olan datalarin userId'sini getir
        ...
        List<String> titles = json.getList("findAll{it.id<5}.title");
                                        // id'si 5'ten kucuk olan datalarin title'larini getir
